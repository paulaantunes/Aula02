...
public class DesvioEncadeadoElseIf {
	...
	public static void main(String[] args) {
		 ...
		 * Para evitar problemas no momento do embarque, porem, voce foi convidado a criar um programa que valide a idade dos passageiros: caso tenham menos de 16 anos, nao podem votar (e nem embarcar). Caso tenham entre 16 anos e 18 incompletos, podem optar por votar ou nao. Caso tenham mais de 18 anos, devem votar obrigatoriamente.
